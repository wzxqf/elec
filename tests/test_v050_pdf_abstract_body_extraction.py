...
def test_v050_tei_extracts_abstract_paragraphs_in_order():
    xml = """
...
def test_v050_tei_extracts_body_titles_and_paragraphs():
    xml = """
    <TEI xmlns="http://www.tei-c.org/ns/1.0">
      <text>
        <body>
...
def test_v050_tei_excludes_back_matter_and_bibliography():
    xml = """
    <TEI xmlns="http://www.tei-c.org/ns/1.0">
      <text>
        <body>
...
def test_v050_clean_text_keeps_content_and_removes_basic_noise():
    raw = "  mar-\nket   risk  \n\n- 1 -\n\n正文  内容\n.\n"
...
def test_v050_safe_stems_disambiguate_duplicate_pdf_names(tmp_path):
...
def test_v050_cli_pymupdf_mode_writes_records_and_report(tmp_path):
    import fitz
