...
> run_timestamp: 2026-05-10T11:18:15+00:00
> device: cuda
...
- `contract_curve_latent`: slice=(154, 174), size=20
  columns: latent_0, latent_1, latent_2, latent_3, latent_4, latent_5, latent_6, latent_7, latent_8, latent_9, latent_10, latent_11, latent_12, latent_13, latent_14, latent_15, latent_16, latent_17, latent_18, latent_19
- `action_head`: slice=(174, 182), size=8
  columns: latent_0, latent_1, latent_2, latent_3, latent_4, latent_5, latent_6, latent_7

## 下层参数块

- `spread_response`: slice=(0, 12), size=12
  columns: price_spread
- `load_deviation_response`: slice=(12, 24), size=12
  columns: load_dev
- `renewable_response`: slice=(24, 36), size=12
  columns: renewable_dev
- `policy_shrink_response`: slice=(36, 48), size=12
