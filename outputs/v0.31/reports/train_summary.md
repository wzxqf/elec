...
- 最新模型路径: HPSO 无模型文件
- 最优模型路径: HPSO 无模型文件
- 训练指标文件: d:\elec\outputs\v0.31\metrics\hpso_weekly_practice_data.csv
- 评估指标文件: d:\elec\outputs\v0.31\metrics\hpso_convergence_curve.csv
- 奖励强基准: dynamic_lock_only
- 中长期价格口径: 2026-02 前采用上一自然周日前均价代理，2026-02 起采用 40% 日前固定价 + 60% 日内联动价混合代理
- 滚动验证窗口数: 3
- 特征清单: d:\elec\outputs\v0.31\reports\feature_manifest.json
- 异常与警告记录: 详见 d:\elec\outputs\v0.31\logs\train.log
