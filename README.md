...
面向湖南电力市场售电公司论文实验的多时间尺度采购策略工程。当前唯一正式口径是 `v0.50`，核心主线固定为：
...
- 唯一正式版本号：`project.version: v0.50`
- 唯一正式训练主线：`training.algorithm: HYBRID_PSO_V040`
- 唯一正式输出目录：`outputs/v0.50/`
...
- 当前版本测试文件统一命名为 `test_v050_<purpose>.py`
