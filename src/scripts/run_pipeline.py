        ...
        _frame_as_markdown(
            pd.DataFrame(
                [
                    ...
                    {"parameter": "reward.lambda_lock_deviation", "value": reward_cfg.get("lambda_lock_deviation", "n/a")},
                    {"parameter": "reward.lambda_positive_lock_deviation", "value": reward_cfg.get("lambda_positive_lock_deviation", "n/a")},
...
def _build_ai_structured_report(context: dict, training: dict, validation: dict, backtest: dict, human_report_path: Path) -> dict:
    ...
    return {
        ...
        "mathematical_model": {
            ...
            "reward": "r_w = X_w - lambda_tail*CVaR_alpha(w) - lambda_hedge*E_w - lambda_lock_deviation*D_abs_w - lambda_positive_lock_deviation*D_pos_w - lambda_trade*F_w - lambda_violate*V_w",
